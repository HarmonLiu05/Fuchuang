...
def prepare_dataloaders(config, seed=42):
    ...
    # 为子集设置 transform（通过访问底层 dataset）
    train_subset.dataset.transform = get_train_transform(config)
    val_subset.dataset.transform = get_val_transform(config)
